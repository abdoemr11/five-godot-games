...
func _ready():
	...
	var door_id = $Wall.tile_set.find_tile_by_name('door_red')
	for cell in $Wall.get_used_cells_by_id(door_id):
		doors.append(cell)
...
func set_camera_limits():
	...
	$Player/Camera2D.limit_right = map_size.end.x * cell_size.x +200
